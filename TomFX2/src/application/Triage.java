...
public class Triage {
    ...
    private static VBox createDateTime(boolean flag){
    ...
    private static VBox createCI(boolean flag){
        VBox ciBox = new VBox();
    ...
    private static VBox createInsurance(boolean flag){
    ...
    private static VBox createVitals(boolean flag){
